...
class AIPPT():
    ...
    def __init__(self,APPId,APISecret,Text,templateId):
        self.APPid = APPId or os.environ.get("XFYUN_ZW_APP_ID", "")
        self.APISecret = (
            APISecret
            or os.environ.get("XFYUN_ZW_API_SECRET", "")
        ...
        if not self.APPid or not self.APISecret:
            raise ValueError("缺少讯飞智文PPT密钥：请通过入参或环境变量 XFYUN_ZW_APP_ID/XFYUN_ZW_API_SECRET 提供")
